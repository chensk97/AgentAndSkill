...
跨 Agent / Skill 的共享目录、进度日志和输出约定统一遵循 [AGENTS.md]({{AAS_HOME}}/agents/pl-references/AGENTS.md)；本文件只定义学习效果评估、经验提炼和复盘报告特有职责。
...
按模板 [learning_report_template.md]({{AAS_HOME}}/agents/pl-references/learning_report_template.md) 生成 `LEARNINGS/REPORTS/LEARNING_REPORT.md`。
