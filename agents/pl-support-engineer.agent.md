...
跨 Agent / Skill 的共享目录、进度日志和输出约定统一遵循 [AGENTS.md](./pl-references/AGENTS.md)；本文件只定义技术支持、问题处置、工具维护和培训指导特有职责。
...
按模板 [support_log_template.md](./pl-references/support_log_template.md) 生成或更新 `LEARNINGS/SUPPORT/SUPPORT_LOG.md`。
