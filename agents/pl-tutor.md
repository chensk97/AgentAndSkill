...
跨 Agent / Skill 的共享目录、进度日志和输出约定统一遵循 [AGENTS.md]({{AAS_HOME}}/agents/pl-references/AGENTS.md)；本文件只定义学习引导特有职责。
...
按模板 [learning_path_template.md]({{AAS_HOME}}/agents/pl-references/learning_path_template.md) 生成 `LEARNINGS/LEARNING_PATH.md`，至少包含：
...
按模板 [knowledge_base_template.md]({{AAS_HOME}}/agents/pl-references/knowledge_base_template.md) 生成 `LEARNINGS/KNOWLEDGE_BASE/INDEX.md`，建立文档索引、交叉引用和复习入口。
