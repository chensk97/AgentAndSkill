...
跨 Agent / Skill 的共享目录、进度日志和输出约定统一遵循 [AGENTS.md]({{AAS_HOME}}/agents/pl-references/AGENTS.md)；本文件只定义项目探索特有职责。
...
1. 先按 [AGENTS.md]({{AAS_HOME}}/agents/pl-references/AGENTS.md) 完成项目根目录确认、断点恢复和启动记录
...
按照模板 [project_map_template.md]({{AAS_HOME}}/agents/pl-references/project_map_template.md) 生成 `LEARNINGS/PROJECT_MAP.md`，至少包含：
